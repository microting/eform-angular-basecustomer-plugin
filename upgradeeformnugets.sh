...
if (( "$GIT_STATUS" > 0 )); then
  ...
  CURRENT_NUMBER_OF_COMMITS=`git log --oneline | wc -l`
	...
	PACKAGES=('Microting.eForm' 'Microting.eFormApi.BasePn' 'Microting.eFormBaseCustomerBase')
	PROJECT_NAME='Customers.Pn.csproj'
	REPOSITORY='eform-angular-basecustomer-plugin'
