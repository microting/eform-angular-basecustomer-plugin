...
if [ -d "~/Documents/workspace/microting/eform-angular-frontend/eform-client/src/app/plugins/modules/customers-pn"]; then
...
if [ -d "~/Documents/workspace/microting/eform-angular-frontend/eFormAPI/Plugins/Customers.Pn"]; then
